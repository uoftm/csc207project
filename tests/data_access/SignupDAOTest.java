...
public class SignupDAOTest {
    ...
    public void testSaveUser() {
        ...
        String fakeEmail = String.format("testSaveUser%s@example.com", UUID.randomUUID().toString().substring(0, 10));
        ...
        Assert.assertThrows(RuntimeException.class, () -> dao.get(testUser.getEmail(), testUser.getPassword()));
    }
}
